...
# FastMCP passes host/port explicitly to its Settings constructor, which overrides env vars.
# We read FASTMCP_HOST and FASTMCP_PORT ourselves so they are honoured.
mcp = FastMCP(
    "intervals-icu",
